...
/** Thanks to Bruno Krebs for his guide on how to use this.
 * The class extends RequestResponseBodyMethodProcessor, which is used for @RequestBody parameters for the REST API input.
 * As such, it will help to convert the JSON body into a DTO instead of expecting an entity
 */
public class DTOModelMapper extends RequestResponseBodyMethodProcessor {
    private static final ModelMapper modelMapper = new ModelMapper();

    // Entity Manager is crucial to query the DB
    ...
    /**
     * Checks the DTO fields being populated in order to check whether there is an @Id.
     */
